...
return array (
  ...
  'Empty column names are not allowed!' => 'Empty column names are not allowed!',
  ...
  'Add a url from where we will import subscribers on a daily basis!' => 'Add a url from where we will import subscribers on a daily basis!',
  'Please note that the url has to point to a valid .csv or .txt file' => 'Please note that the url has to point to a valid .csv or .txt file',
  'Save url' => 'Save url',
  'Ping page' => 'Ping page',
  ...
  'From a total of {total} possible subscribers, so far {totalProcessed} have been processed, {successfullyProcessed} successfully and {errorProcessing} with errors. {percentage} completed.' => 'From a total of {total} possible subscribers, so far {totalProcessed} have been processed, {successfullyProcessed} successfully and {errorProcessing} with errors. {percentage} completed.',
  'Your list already contains {currentFieldsCount} custom fields, the import process cannot create new custom fields({newFieldsCount}), it would go above the list custom fields limit which is currently set to {maxFieldsCount}.' => 'Your list already contains {currentFieldsCount} custom fields, the import process cannot create new custom fields({newFieldsCount}), it would go above the list custom fields limit which is currently set to {maxFieldsCount}.',
